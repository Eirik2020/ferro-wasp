...
pub use manifest::{
    ...
    OPTIONAL_ESC_TELEMETRY_CLAIMS, OPTIONAL_SPI_FLASH_CLAIMS, OPTIONAL_USB_CDC_CLAIMS, PIN_MAP,
    SWD_PINS, SYSTEM_CLOCK_HZ, Spi1ImuKind, TIMER_GROUPS, USB_FS_PINS,
};
pub use routes::{
    ACTIVE_DMA_ROUTES, ACTIVE_SERIAL_ROUTES, ACTIVE_SPI_ROUTES, ACTIVE_STATIC_PWM_ROUTES,
    DEFERRED_MOTOR_DMA_ROUTES, OPTIONAL_ESC_TELEMETRY_DMA_ROUTE, OPTIONAL_SPI2_FLASH,
};

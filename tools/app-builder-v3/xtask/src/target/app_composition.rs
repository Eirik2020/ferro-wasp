...
pub const CONTROL_TIMER: PeriodicControlDeclaration = PERIODIC_CONTROL_TIMER
    ...
    .task(&stm32f4_tasks::foxeer_control::CONTRACT)
    .safety_critical()
    .with_local(&[
        stm32f4_tasks::foxeer_control::LOCAL
            .sbus
    ...
    .with_shared(&[
        stm32f4_tasks::foxeer_control::SHARED
            .telemetry
    ...
    .with_spawns(&[stm32f4_tasks::foxeer_control::SPAWNS
        .actuator_wake

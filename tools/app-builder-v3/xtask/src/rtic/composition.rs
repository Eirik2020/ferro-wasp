...
use crate::hardware_definitions::stm32f4::dshot_actuator;
use crate::hardware_definitions::stm32f4::golden_services;
...
mod tests {
    ...
    const TEST_OBSERVER: TaskDeclaration = TaskDeclaration::software(
        ...
        &crate::tasks::observe_button_change::CONTRACT,
    )
    .priority(1);
    ...
    fn periodic_control_cannot_consume_the_tim2_monotonic() {
        const TIM2_CONTROL:
            crate::hardware_definitions::stm32f4::periodic_control::PeriodicControlDeclaration =

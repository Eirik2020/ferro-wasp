...
use crate::{
    backends::stm32f4::{
        ...
        endpoints::imu::{self as imu_endpoint, ImuEndpointDeclaration},
        endpoints::serial::{self as serial_endpoint, SerialEndpointDeclaration},
        periodic_control::{self, PeriodicControlDeclaration},
    },
    input_catalog::foxeer_golden_services::{self as golden_services, GoldenServicesDeclaration},
};

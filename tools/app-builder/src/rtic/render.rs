...
use crate::{
    backends::stm32f4::lower::{self, RenderedHardware, RenderedInitLocal},
    rtic::{
...
fn render_prelude(imports: &str, has_safety_channels: bool) -> String {
    ...
    format!(
        concat!(
            ...
            "    initial_stored_config, initial_tuning_profile, INITIAL_FLASH_LOG_RATE_DIVISOR,\n",
            "    INITIAL_TUNING_REQUEST_SEQ,\n",
            "}};\n",
            "{safety_imports}",
            "{imports}\n",
        ),
...
/// Renders the app-owned bounded live-configuration defaults.
pub fn render_live_config(
    initial_tuning_request_seq: u32,
    initial_log_rate_divisor: u32,
) -> String {
    format!(
        concat!(
            "// GENERATED FILE — DO NOT EDIT DIRECTLY\n",
            ...
            "pub(crate) const INITIAL_TUNING_REQUEST_SEQ: u32 = {initial_tuning_request_seq};\n",
            "pub(crate) const INITIAL_FLASH_LOG_RATE_DIVISOR: u32 = {initial_log_rate_divisor};\n\n",
        ...
        initial_tuning_request_seq = initial_tuning_request_seq,
        initial_log_rate_divisor = initial_log_rate_divisor,
    )
}
...
mod tests {
    use super::*;
    use crate::{
        input_catalog::foxeer_f405_v2::app_composition::APP_COMPOSITION,
        rtic::{
